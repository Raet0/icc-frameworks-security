...
public interface ProductRepository extends JpaRepository<ProductEntity, Long> {
    ...
    /**
     * Busca productos por categoría con paginación (renamed for consistency)
     */
    ...
    @Query("SELECT p FROM ProductEntity p " +
           "JOIN p.owner o " +
           "JOIN p.categories c " +  // Fixed: plural
    ...
    /**
     * Productos de una categoría usando Slice (renamed for consistency)
     */
